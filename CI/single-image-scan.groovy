...
pipeline {
    ...
    parameters {
        string(name: 'targetImage', defaultValue: 'docker.artifactory.euw.platformservices.io/rob/omnom', description: 'Artifactory endpoint for target image to scan')
    }
    stages {
        stage('Scan Image') {
            agent {
