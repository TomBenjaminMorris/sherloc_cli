...
Gem::Specification.new do |s|
  ...
  s.authors = ["Aslak Helles\u{f8}y".freeze, "David Chelimsky".freeze, "Mike Sassak".freeze, "Matt Wynne".freeze, "Jarl Friis".freeze, "Dennis G\u{fc}nnewig".freeze]
  s.date = "2019-12-28"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<childprocess>.freeze, ["< 4.0.0", ">= 0.6.3"])
      ...
      s.add_runtime_dependency(%q<thor>.freeze, ["< 2.0", ">= 0.19"])
      s.add_development_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.7"])
    else
      s.add_dependency(%q<cucumber>.freeze, [">= 1.3.19"])
      s.add_dependency(%q<childprocess>.freeze, ["< 4.0.0", ">= 0.6.3"])
      ...
      s.add_dependency(%q<thor>.freeze, ["< 2.0", ">= 0.19"])
      s.add_dependency(%q<bundler>.freeze, ["< 3.0", ">= 1.7"])
    end
  else
    s.add_dependency(%q<cucumber>.freeze, [">= 1.3.19"])
    s.add_dependency(%q<childprocess>.freeze, ["< 4.0.0", ">= 0.6.3"])
